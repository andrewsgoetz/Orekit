...
import org.orekit.time.UTCScale.UTCTemporalAccessor;
...
public final class UTCFields {
     ...
     */
    abstract static class AbstractUTCField implements UTCField {
         ...
         */
        AbstractUTCField(final UTCScale utcScale, final ChronoUnit baseUnit, final ChronoUnit rangeUnit) {
        ...
        public boolean equals(final Object obj) {
            ...
            final AbstractUTCField other = (AbstractUTCField) obj;
            return this.getUTCScale().equals(other.getUTCScale());
        }

        @Override
        public int hashCode() {
            return getUTCScale().hashCode();
        }

        /**
         * Returns the adjustment to TAI-UTC made at the <em>end</em> of the day containing the specified
         * time.
         * @param temporal temporal, not null
         * @return adjustment (seconds)
         */
        protected double getAdjustment(final TemporalAccessor temporal) {
