...
public final class UTCFieldsTest {
    ...
    public void testAbstractUTCField() {
        ...
        Assert.assertTrue(utcSecondOfDay.isSupportedBy(utc.dateToTemporal(AbsoluteDate.ARBITRARY_EPOCH)));
        ...
        Assert.assertEquals(43200L, utcSecondOfDay.getFrom(utc.dateToTemporal(date)));
        ...
        Assert.assertTrue(utcSecondOfMinute.equals(utcSecondOfMinute));
        Assert.assertTrue(utcSecondOfMinute.equals(new UTCSecondOfMinute(utc)));
        Assert.assertFalse(utcSecondOfMinute.equals(new Object()));

        Assert.assertEquals(utcSecondOfMinute.hashCode(), new UTCSecondOfMinute(utc).hashCode());
    }
